...
namespace RefactorExercise
{
    ...
    public GoalieStatistics(Season season)
        ...
        public double getGoalsAgainstAverage()
        {
            ...
            {
                int totalGoalsAgaint = season.getTotalGoalsAgainst();

                double totalMinutesPlayed = season.getTotalMinutesPlayed();

                return (totalGoalsAgaint / totalMinutesPlayed) * 60;
            }
        }
        ...
        public double getSavePercentage()
        {
            ...
            else
            {
                ...
                return ((double)totalSogAgainst - totalGoalsAgaint) / totalSogAgainst;
            }
        }
    }
}
